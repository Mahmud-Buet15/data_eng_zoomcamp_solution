...
BIGQUERY_DATASET = os.environ.get("BIGQUERY_DATASET", 'example_dataset')  # dataset need to be available in GCP   #if the value for BIGQUERY_DATASET not available, trips_data_all will be used as default value
...
with DAG(
    ...
    download_dataset_task >> uncompress_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> bigquery_external_table_task